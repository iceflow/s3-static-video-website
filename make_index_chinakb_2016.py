...
def get_obj_info(key):
    ''' 
    Custom  caterory
    2016/re -Invent 2016 Breakout Sessions _ Alexa/1 - AWS re -Invent 2016 - State of the Union - Amazon Alexa and Advances in Conversational AI (ALX306).mp4"
    '''
    info = {}
