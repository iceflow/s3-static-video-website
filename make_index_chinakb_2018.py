...
def get_obj_info(key):
    ''' 
    Custom  caterory
    AWS re -Invent 2018 Breakout Sessions _ GPS-Technical/1 - AWS re -Invent 2018 - Networking, Storage, Data Protection Deep Dive w_ VMware Cloud on AWS GPSTEC307.mp4
    AWS re -Invent 2018 _ Launch Announcements/1 - AWS re -Invent 2018 - Announcing Amazon SageMaker Neo.mp4
    '''
    info = {}
    ...
    # Keynote tags
    if 'AWS re -Invent 2018 Keynote' in key:
        info['category'] = 'Keynotes' 
    elif 'Invent 2018 Launchpad Live Streams' in key:
